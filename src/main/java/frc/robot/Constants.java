...
public static final double armCruiseVelocity = 30000; //10000;
public static final double armAcceleration = 25000; //5000
...
public static final double ARM_MAX_EXTENSION_TICKS =  (35/(0.787*Math.PI))*20*2048;  //at 35 inches
public static final double ARM_MIN_RETRACTION_TICKS = (4/(0.787*Math.PI))*20*2048;  //4 inches)
...
public static final double pivotCruiseVelocity = 6000;
...
public static final double PIVOT_MIN_ROTATION_LIMIT = 20;
